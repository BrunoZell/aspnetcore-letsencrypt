...
namespace WebApp {
    public static class Program {
        ...
        private static IWebHostBuilder CreateWebHostBuilder(string[] args, Certificate certificate) =>
            WebHost.CreateDefaultBuilder(args)
                ...
                .UseKestrel(options => {
                    ...
                    options.ListenAnyIP(443, o => o.UseHttps(certificate.Filename, certificate.Password));
                })
                .Configure(app => {
